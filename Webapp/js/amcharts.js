        ...
        parseDatesDraw: function () {
            ...
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    m = l = p;
                    if (!isNaN(u))
                        for (h = 1; h < v; h += u) this.gridAlpha = this.minorGridAlpha, f = p + z * h, f = d.resetDateToMin(new Date(f), A, u, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
                    this.gridAlpha = x
                }
        },
                            ...
                            if (t = x * g + c, t = d.roundTo(t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t)
                                if (isNaN(z) || Number(d.toFixed(t, z)) == t) {
                                    ...
                                    if (t == this.baseValue && "radar" != a.type) {
                                        ...
                                        D && (v = d.fitToBounds(2 * this.gridAlpha, 0, 1), isNaN(this.zeroGridAlpha) || (v = this.zeroGridAlpha), v = d.line(a.container, D, C, this.gridColor, v, 1, this.dashLength), v.translate(this.x, this.y), this.grid0 = v, a.axesSet.push(v), v.toBack(), d.setCN(a, v, this.bcn + "zero-grid-" + this.id), d.setCN(a, v, this.bcn + "zero-grid"))
                                    }
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            if ("H" == Oa) {
                ...
                w += r / 2;
                "right" == ea ? (G += va + ya + da, w += ma, I ? (f || (w -= r / 2 + 3), G = G - (B + 4) - Z) : (G += B + 4 + v, w -= 2, G += Z)) : I ? (G += B + 4 - da, f || (w -= r / 2 + 3), g && (G += va, w += ma), G += Z) : (G += -B - v - 4 - 2 - da, w -= 2, G -= Z);
            ...
            ba && (ba.attr({
                "text-anchor": ga
            }), ba.translate(G, w, NaN, !0), 0 !== n && ba.rotate(-n, a.chart.backgroundColor), a.allLabels.push(ba), this.label = ba, d.setCN(p, ba, a.bcn + "label"), d.setCN(p, ba, q, !0), g && d.setCN(p, ba, "guide"));
    ...
    d.AmGraph = d.Class({
        ...
        createSerialGraph: function () {
            ...
            for (L = Q; L <= ia; L++) {
                ...
                if (Ia) {
                    ...
                    $a = !1;
                    isNaN(W) || (m ? W > Ta ? (Sa && ($a = !0), Sa = !1) : (Sa || ($a = !0), Sa = !0) : w.isNegative = W < Oa ? !0 : !1, za = W);
                    var Ob = !1;
                    ...
                    case "line":
                        ...
                        break;
                    case "smoothedLine":
                        if (isNaN(W)) x || (this.drawSmoothedGraph(z, v, U, V), z = [], v = [], U = [], V = []);
                        else {
                            if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb) z.push(E), v.push(F), jb = E, kb = F;
                            wa = E;
                            Da = F;
                            ...
                            w.gap && (this.drawSmoothedGraph(z, v, U, V), z = [], v = [], U = [], V = [])
                        }
                        break;
                    case "step":
                        if (!isNaN(W)) {
                            ...
                            if (1 >= this.periodSpan || 1 < this.periodSpan && E - A > xa + Ga) A = y = NaN;
                            this.drawLineGraph(z, v, U, V);
                            z = [];
                            v = [];
                            U = [];
                        ...
                        if (!isNaN(W)) {
                            ...
                            if (!(W < Pb && ob < Pb || W > Qb && ob > Qb)) {
                                ...
                                if (t) {
                                    ...
                                    "3d" == O ? (R = E - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + H * ea, P = M + S * ea, Ba = ea) : (R = E - (r / 2 - ea) * (k + T) + T / 2, P = M, Ba = 0);
                                    K = k;
                                    wa = R + k / 2;
                                    Da = F;
                                    ka = R + k / 2;
                                    ...
                                    K = d.roundTo(K, 2);
                                    aa = d.roundTo(aa, 2);
                                    R < n + ea * H && 0 < K && (this.showOnAxis && (P -= S / 2), ua = new d.Cuboid(h, K, aa, H - a.d3x, S - a.d3y, Ma, Va, ca, Aa, this.lineAlpha, ga, u, t, da, bb, mb, Z), w.columnHeight = Math.abs(aa), w.columnWidth = Math.abs(K))
                                }
                            }
                            if (ua) {
                                Ea = ua.set;
                                ...
                                if (!I) {
                                    ...
                                    "3d" == O && (t ? (J = (this.end + 1 - L) * C - c - 1E3 * this.depthCount, wa += H * this.columnIndex, ka += H * this.columnIndex, w.y += H * this.columnIndex) : (J = (C - c) * (L + 1) + 1E3 * this.depthCount, Da += S * this.columnIndex, la += S * this.columnIndex, w.y += S * this.columnIndex));
                        ...
                        if (!isNaN(ta) && !isNaN(W)) {
                            ...
                            if (t) {
                                ...
                                if (P < q && 0 < K) {
                                    ...
                                    aa = E - N;
                                    ua = new d.Cuboid(h, aa, K, H, S, Ma, Ya, ca, Aa, X, ga, u, t, da, bb, mb, Z)
                                }
                            } else {
                                "open" == l && (la = M);
                                "high" == l && (la = sa);
                                ...
                                if (R < n && 0 < K) {
                                    ...
                                    !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Fb, Aa, X, ca), cb = d.line(h, [E, E], Gb, Aa, X, ca), d.setCN(a, Xa, this.bcn + "line-high"), w.className && d.setCN(a, Xa, w.className, !0), d.setCN(a, cb, this.bcn + "line-low"), w.className && d.setCN(a, cb, w.className, !0))
                                }
                            }
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(z, v, U, V) : this.drawLineGraph(z, v, U, V), I || this.launchAnimation();
        ...
        drawSmoothedGraph: function (a, b, c, e) {
            if (1 < a.length) {
                ...
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + z + "," + b[b.length - 1], n += " L" + z + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + z, n += " L" + a[0] + "," + z), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(g, m, p, NaN, 0, 0, t, q, h, n, v), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), u || void 0 !== r) && (x || (x = q), u || (u = r), a = new d.Bezier(g, a, b, NaN, 0, 0, u, x, h, n, v), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
        },
...
2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], e, h, f, g, k, m - 180, void 0, p);
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        if (0 < l) {
            ...
            l = a.path(" M" + D + "," + C + " L" + D + "," + (C + l) + " L" + J + "," + (v + l) + " L" + J + "," + v + " L" + D + "," + C + " Z", void 0, void 0, "1000,1000").attr(H);
            e.push(Q);
            e.push(l)
        }
        ...
        a.handDrawn && (k = d.line(a, [z, y], [A, B], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]), e.push(k));
